...
import AggregatedNetwork from "./pages/AggregatedNetwork"
...
const MainApp: React.FC = () => {
  ...
  return (
    <ErrorBoundary>
      ...
      >
        <main className="flex z-20 w-full flex-col gap-4 p-4 md:p-10 md:pt-8">
          <RefreshToast />
          <Header />
          <DashCommand />
          <Routes>
            <Route path="/" element={<Server />} />
            <Route path="/network" element={<AggregatedNetwork />} />
