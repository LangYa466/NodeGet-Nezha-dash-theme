...
// Card 组件的基础样式（改用 <Link> 渲染，让卡片成为真实链接，浏览器悬停可显示 URL）
const CARD_BASE = "rounded-lg border bg-card text-card-foreground shadow-lg shadow-neutral-200/40 dark:shadow-none"
